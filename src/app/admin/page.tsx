import { BadgeDollarSign, Flame, LayoutGrid, MessageSquareText, Newspaper, Trophy, Users } from "lucide-react";
...
const sections = [
  ...
  {
    title: "Engagement",
    description: "Moderate comments and manage article polls.",
